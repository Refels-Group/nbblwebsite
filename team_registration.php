...
<head>
    ...
    <meta charset="UTF-8">
        ...
        <link href="team_registration.css" rel="stylesheet" type="text/css" media="screen" />
...
<body background="bilder\bier.jpg">
        ...
        <div id="head_container"> 
			<div id="header"> <span class="Stil1">&raquo;</span> N.B.B.L - Teamanmeldung <span class="Stil1">&laquo;</span>
			</div>
			<!-- ende header -->
